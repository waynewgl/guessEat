...
@interface GZCollectionViewController ()
@property (strong, nonatomic) UICollectionView *imgsCollectionView;
@property (strong, nonatomic) GZViewController *gv;
...
- (void)viewDidLoad
{
    ...
    UIBarButtonItem *backItem = [[UIBarButtonItem alloc] initWithTitle:@"go"
...
- (void)goBack:(id)sender
{
    ...
    NSLog(@"go back");
    self.gv= [[GZViewController alloc]init];

    [self.navigationController pushViewController:self.gv  animated:YES];
}
